        ...
        <div class="row justify-content-center">
            <div class="col-md-8"><div class="card">
                <div class="card-body">
                    ...
                    <p>Gift Out ("us", "we", or "our") operates the  127.0.0.1:8000 website and the Gift Out mobile application (hereinafter referred to as the "Service").</p>

                    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. The Privacy Policy  for Gift Out has been created with the help of <a href="https://www.termsfeed.com/">TermsFeed</a>.</p>
                    ...
                    <ul>
                        <li>
                            <p><strong>Service</strong></p>
                                    <p>Service means the  127.0.0.1:8000 website and the Gift Out mobile application operated by Gift Out</p>
                                </li>
                        <li>
                    ...
                    <p>Gift Out uses the collected data for various purposes:</p>    
                    <ul>
                    ...
                    <p>Gift Out will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                    <h2>Disclosure Of Data</h2>

                    <h3>Legal Requirements</h3>
                    <p>Gift Out may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of Gift Out</li>
                    ...
                    <ul>
                    <li>By email: olivdeco1@student.arteveldehs.be</li>
                    </ul>
                </div>
            </div>
        </div>
